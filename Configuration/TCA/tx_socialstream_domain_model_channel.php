...
return array(
	'ctrl' => array(
		...
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('social_stream') . 'Resources/Public/Icons/socialstream_domain_model_channel_facebook.svg',
		'typeicon_column' => 'type',
		'typeicon_classes' => array(
			'facebook' => 'extensions-social_stream-facebook',
			'facebookevent' => 'extensions-social_stream-facebook',
			'instagram' => 'extensions-social_stream-instagram',
			'youtube' => 'extensions-social_stream-youtube',
			'twitter' => 'extensions-social_stream-twitter',
			'xing' => 'extensions-social_stream-xing',
			'linkedin' => 'extensions-social_stream-linkedin',
			'soundcloud' => 'extensions-social_stream-soundcloud',
		),
	),
	'interface' => array(
			...
			'config' => array(
				...
				'wizards' => array(
					'token' => array(
						...
						'icon' => 'EXT:social_stream/Resources/Public/Icons/social/###REC_FIELD_type###.png',
					)
				)
			),
		),
