...
class GetFeedCommandController extends \TYPO3\CMS\Extbase\Mvc\Controller\CommandController
{
    ...
    public function getFeedCommand($rootPage = 1)
    {
        ...
        $this->channelRepository = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(
            'Socialstream\\SocialStream\\Domain\\Repository\\ChannelRepository'
        );
        $this->newsRepository = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(
            'Socialstream\\SocialStream\\Domain\\Repository\\NewsRepository'
        );
        $this->categoryRepository = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(
